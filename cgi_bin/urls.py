...
urlpatterns = patterns('',
    ...
    url(r'^actions/get-admin-access-token$', views.admintoken, name='admintoken'),
    url(r'^landing/$', login_required(views.landing), name='landing'),
    url(r'^show/show-user$', login_required(views.show_user), name='show_user'),
    url(r'^actions/find-user$', views.find_user, name='find_user'),
    url(r'^actions/create-user$', views.create_user, name='create_user'),
